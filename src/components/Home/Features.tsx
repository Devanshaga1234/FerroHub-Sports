...
// Correct typing for dynamic variants
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose FerroHub Sports?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, i) => (
            <motion.div
              key={i}
              className="bg-white rounded-xl p-8 shadow-sm hover:shadow-lg transform transition-all duration-300 hover:-translate-y-2"
              custom={i}
              variants={fadeInUp}
              initial="hidden"
              whileInView="visible"
